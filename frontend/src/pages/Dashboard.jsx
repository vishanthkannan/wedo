...
const Dashboard = () => {
  ...
  const handleAddTask = async (e) => {
    ...
    if (!newTaskTopic) {
      alert("Please select a domain (Daily, Health, Study, or Work) for your habit.");
      return;
    }
    ...
    <>
      ...
      <div className="dashboard-grid" style={{ marginTop: '24px' }}>
        ...
        <div style={{ gridColumn: '1 / -1' }}>
          ...
          <div className="tracker-grid-container" style={{ display: initialLoading ? 'flex' : 'block', justifyContent: 'center', alignItems: 'center' }}>
            {initialLoading ? (
              <div style={{ padding: '80px 0', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
